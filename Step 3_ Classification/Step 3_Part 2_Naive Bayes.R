...
copacabana_nb <- alpha %>%
  ...
  select('bedrooms', 'review_scores_location','review_scores_cleanliness', 'property_type','room_type', 'instant_bookable', 'host_is_superhost', 'require_guest_phone_verification',
          'cancellation_policy') 
